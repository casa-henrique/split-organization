...
export default function Home() {
  ...
  return (
    <ScrollView className="flex w-full h-full bg-white p-5">
      <SafeAreaView>
        <View className="flex flex-row w-full mt-4 justify-between items-center">
        ...
        <View className={`border-t border-[#c7c7c76d] pt-5 ${sectionStyle}`}>
              ...
              <TouchableOpacity className={sectionItem} key={i}>
                ...
                <View className="flex flex-row items-center justify-between w-full">
                  ...
                  <View className="flex flex-row items-center gap-3">
                    ...
                    <View className="bg-red-400 rounded-full size-8 justify-center items-center">
                      <StyledText className="text-xs">
                        {item.assigned.split("")[0]}
                      </StyledText>
                    </View>
